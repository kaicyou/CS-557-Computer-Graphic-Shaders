...
const char *WINDOWTITLE = { "OpenGL Compute Shader Particle System -- Joe Graphics" };
...
Animate( )
{
	...
	MyComputeShaderProgram->DispatchCompute( NUM_PARTICLES  / WORK_GROUP_SIZE, 1,  1 );
...
InitGraphics( )
{
	...
	{
		fprintf( stderr, "Compute Shader was created OK\n" );
		GLenum format;
		MyComputeShaderProgram->SaveProgramBinary( "particles.nvb", &format );
	}
